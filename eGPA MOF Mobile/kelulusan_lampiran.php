...
-->
    ...
    <ion-content class="scroll-content ionic-scroll overflow-scroll  has-header has-tabs" overflow-scroll="true"><div class="scroll">
        <div class="breadcrumb ng-binding">Bekalan &amp; Perkhidmatan Bukan Perunding &gt; Rundingan Terus Agensi &gt; Dokumen Sokongan</div>
        <div class="paddingContent">
        
        	<span id="senaraidokumensokongan" name="senaraidokumensokongan"></span>
        	
        	<!--
        	<div class="row">
            	<div class="col col-20"><img src="img/MS_Word.svg" class="ms_icon"></div>
            	<div class="col align_ms_icon">kalo_detect_ms_word.doc<br>13.3KB</div>
            </div>
            <div class="row">
...
<script>
    ...
    function getListDokumenSokongan(appid)
    {
    
					var TX = "" + Math.random();
					var url = "service.php?actionid=ListDokumenSokongan&appId="+appid+"&TX=" + TX;
						...
						$.ajax({
						  ...
						  success: function(response){
     						  	//alert('ListDokumenSokongan response=' + response);
						  		if (response == "")
						  		{
						  			//ada error..
						  		...
						  		else
						  		{
						  			...
						  			/*
						  			 response=[{"ID":"938","DOCTYPE":"749","CREATED_BY":"4","KETERANGAN":"eee","NAMAFAIL":"SLIP TANDATANGAN.txt",
						  			 "NAMA":"BAKHRURAZILA BAHAROM","TARIKH":"2015-03-23 12:13:00",
						  			 "MUATTURUN":"<a href=\"..\/custom\/download.php?id=938\">MUAT TURUN<\/a>"}
						  			*/
						  				...
						  				x1 = x1 + '<div class="row">' +
							                 ...
							                 x = x + '<div class="card">'+
							                    ...
							                    '<ion-item class="item-accordion no-animation item ng-hide">'+
							                    	'<div class="row">'+
							                            '<div class="col"><b>DIMUAT NAIK OLEH</b><br>' + jsonobj[i].NAMA + '</div>'+
							                        '</div>'+
							                        '<div class="row">'+
							                            '<div class="col"><b>TARIKH MUAT NAIK</b><br>' + jsonobj[i].TARIKH + '</div>'+
							                        '</div>'+
							                        '<div class="row">'+
